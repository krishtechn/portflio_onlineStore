  ...
  return (
    <div className='w-full flex justify-between flex-row mt-5'>
                    <div className='flex flex-col'>
                        <p className='text-xs-r text-secondary-500'>Payment Status</p>
                        <h1 className={`${payment.status == "paid"?"text-success-600":"text-error-700"} text-sm-m capitalize font-bold`}>{payment.status}</h1>
                    </div>

                    <div className='flex flex-col'>
                        <p className='text-xs-r text-secondary-500'>Payment Method</p>
                        <h1 className='font-medium text-secondary-500 text-sm-m'>{payment.method}</h1>
                    </div>


                    <div className=' flex flex-row items-center'>
                        <div>
                            <p className='text-xs-r text-secondary-500'>ID Number</p>
                            <h1 className='font-medium text-secondary-500 text-sm-m'>{payment.idNo}</h1>
                        </div>
