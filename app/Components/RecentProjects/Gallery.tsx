...
const Video = (props?: any) => {
    return (
        <>
        {props.data.map((items?:any,index?:number)=><div className='md:w-[33%] w-full my-[15px] shadow-2xl p-[10px]'>
            <img className='rounded-[5px] object-contain w-full md:h-[220px] h-full' src={items.link} />
